...
Путь для Android выше проверен компиляцией на свежем приложении из шаблона RN 0.86 с библиотекой, установленной из npm-тарбола. Если ваш проект отличается от шаблона, ориентируйтесь на [руководство Expo по bare-установке](https://docs.expo.dev/bare/installing-expo-modules/).
